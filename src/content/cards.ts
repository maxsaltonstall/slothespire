...
export const CARD_DEFS: Record<string, CardDef> = {
  ...
  load_balancer: {
    ...
    effects: [{ kind: "headroom", amount: 7 }, { kind: "applyStatus", status: "throttled", stacks: 1, target: "single" }],
    upgradedEffects: [{ kind: "headroom", amount: 10 }, { kind: "applyStatus", status: "throttled", stacks: 2, target: "single" }],
    flavor: "Distribute the pain. And slow the source.",
  },
  monitoring_alert: {
    id: "monitoring_alert", name: "Monitoring Alert", type: "attack", cost: 0,
    effects: [{ kind: "burn", amount: 4 }, { kind: "applyStatus", status: "observability", stacks: 1, target: "self" }],
    upgradedEffects: [{ kind: "burn", amount: 6 }, { kind: "applyStatus", status: "observability", stacks: 1, target: "self" }],
    flavor: "Better late than never. And now you can see what's next.",
  },
  feature_flag: {
    id: "feature_flag", name: "Feature Flag", type: "skill", cost: 1,
    effects: [{ kind: "draw", amount: 2 }, { kind: "applyStatus", status: "observability", stacks: 1, target: "self" }],
    upgradedEffects: [{ kind: "draw", amount: 3 }, { kind: "applyStatus", status: "observability", stacks: 1, target: "self" }],
    flavor: "Ship it. Just turn it off if it breaks something.",
  },
  health_check: {
  ...
  quick_fix: {
    ...
    effects: [{ kind: "burn", amount: 9 }],
    upgradedEffects: [{ kind: "burn", amount: 13 }],
    exhaust: true,
  ...
  redundancy: {
    ...
    effects: [{ kind: "headroom", amount: 6 }, { kind: "applyStatus", status: "stability", stacks: 1, target: "self" }],
    upgradedEffects: [{ kind: "headroom", amount: 9 }, { kind: "applyStatus", status: "stability", stacks: 2, target: "self" }],
    flavor: "Two is one. One is none. And the backup makes everything stronger.",
  },
  sla_penalty: {
